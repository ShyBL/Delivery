...
public class Resource : MonoBehaviour
{
    ...
    [Tooltip("Select the type of Resource.")]
    [SerializeField] private ResourceType m_ResourceType = ResourceType.Scraps;

    [Tooltip("The visual model of the Resource (will rotate automatically).")]
    [SerializeField] private GameObject m_ResourceModel;

    [Tooltip("Rotation speed in degrees per second.")]
    [SerializeField] private float m_RotationSpeed = 50f;
    
    private ResourceSpawner m_Spawner; // Reference set by spawner
    ...
    private void Update()
    {
        if (m_rotate)
        {
            m_ResourceModel.transform.Rotate(Vector3.forward, m_RotationSpeed * Time.deltaTime);
        }
    }
    ...
    /// </summary>
    public void SetSpawner(ResourceSpawner spawner, GameManager gameManager)
    {
        m_Spawner = spawner;
    ...
    /// </summary>
    public ResourceType GetPackageType()
    {
